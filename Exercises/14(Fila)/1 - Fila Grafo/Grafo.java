...
public class Grafo {
    ...
    */
    ...
    // Entrada: um grafo G representado em uma estrutura de dados e um vértice v
    // Saída:  visita a partir v todos os vértices do grafo em largura
    void buscaLargura(int v) {
        // inicializar uma fila F
        Fila F = new Fila(this.V);
        ...
        while( ! F.isEmpty() ){
            ...
            // imprime u
            System.out.print(u+" ");
            //para Cada vértice w adjacente a u faça
            for( int w = 0; w < this.V; w++){
                if( this.adj[u][w]==1 && ! visitados[w]){ // w eh adjacente a v
    ...
    // Entrada: um grafo G representado em uma estrutura de dados e um vértice v
    // Saída:  cacula a distancia de v para todos os vértices do grafo em largura
    int[] distancia(int v) {
        // aloca um vetor de distancia para retorno
        int dist[] = new int[this.V];
        // cada posicao do vetor comeca com -1
        for(int i=0;i<this.V;i++)
            dist[i]=-1;
        ...
        while( ! F.isEmpty() ){
		    ...
		    // colocar w na fila F
                    F.insere(w);
                    // calcula a distancia de u para w
                    // ou seja, dist[u]+1
                    dist[w] = dist[u]+1;
